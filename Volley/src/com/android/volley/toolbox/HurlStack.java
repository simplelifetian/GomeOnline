...
public class HurlStack implements HttpStack {
	...
	/* package */static void setConnectionParametersForRequest(HttpURLConnection connection, Request<?> request) throws IOException, AuthFailureError {
		...
		case Method.DEPRECATED_GET_OR_POST:
			...
			break;
		case Method.GET:
			// Not necessary to set the request method because connection defaults to
			// GET but
			// being explicit here.
		...
		case Method.POST:
			...
			break;
		case Method.TEXTPOST:
			connection.setRequestMethod("POST");
			addTextBodyIfExists(connection, request);
			break;
		case Method.PUT:
	...
	private static void addBodyIfExists(HttpURLConnection connection, Request<?> request) throws IOException, AuthFailureError {
		...
		VolleyLog.e("VolleyLog", new String(body));
		if (body != null) {
			connection.setDoOutput(true);
	...
	private static void addTextBodyIfExists(HttpURLConnection connection, Request<?> request) throws IOException, AuthFailureError {
		byte[] body = request.getTextBody();
		VolleyLog.e("VolleyLog", new String(body));
		if (body != null) {
			connection.setDoOutput(true);
			connection.addRequestProperty(HEADER_CONTENT_TYPE, request.getTextBodyContentType());
//			DataOutputStream out = new DataOutputStream(connection.getOutputStream());
