...
public class Recorder implements OnCompletionListener, OnErrorListener {
	...
	private long mSampleLengthMills = 0; // length of current sample
	...
	public long sampleLengthMill() {
		return mSampleLengthMills;
	}
	...
	public void stopRecording() {
		if (RecorderService.isRecording()) {
			...
			mSampleLengthMills = (System.currentTimeMillis() - mSampleStart);
			mSampleLength = (int) ( mSampleLengthMills/ 1000);
			if (mSampleLength == 0) {
