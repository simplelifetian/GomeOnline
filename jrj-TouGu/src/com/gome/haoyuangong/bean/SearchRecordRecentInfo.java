...
@DatabaseTable(tableName = SearchRecordRecentInfo.TABLE_NAME)
public class SearchRecordRecentInfo {
	...
	public SearchRecordRecentInfo() {
		super();
	}
	
	public SearchRecordRecentInfo(String custId, String agentId, String custName,
