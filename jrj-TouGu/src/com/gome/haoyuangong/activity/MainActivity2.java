...
import com.gome.haoyuangong.delegate.InitializeDelegate;
import com.gome.haoyuangong.delegate.PoolAsyncTask;
...
public class MainActivity2 extends BaseActivity {
	...
	// 定义数组来存放Fragment界面
	private Class fragmentArray[] = { DongTaiFragment.class,
			FoundFragments.class,
			EmptyFragment.class,
			// FragmentPage4.class,
			SelfFragment.class };
	// 定义数组来存放按钮图片
	...
	// Tab选项卡的文字
	private int mTextViewArray[] = { R.string.home, R.string.message,
			R.string.friends,
			// R.string.square,
			R.string.more };
...
//		InitializeDelegate delegate = new InitializeDelegate(
//
//		MainActivity.this);
//
				...
				new RequestHandlerListener<UserIdentifiedResult>(getContext()) {
					...
					public void onSuccess(String id, UserIdentifiedResult data) {
						...
						if (data.getRetCode() == 0 && data != null) {
							...
							UserInfo.saveUserInfo(MainActivity2.this,
