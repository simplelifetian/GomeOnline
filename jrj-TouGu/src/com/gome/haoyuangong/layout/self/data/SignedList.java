...
public class SignedList extends TouguBaseResult {
	...
	public class Data{
		...
		private ArrayList<SignedItem> list = new ArrayList<SignedItem>();

		public ArrayList<SignedItem> getList() {
			return list;
		}

		public void setList(ArrayList<SignedItem> list) {
			this.list = list;
		}
